...
(X_train, y_train), (X_test, y_test) = keras.datasets.mnist.load_data() # In case of error, run:  /Applications/Python\ 3.11/Install\ Certificates.command
...
# In[4]: [exercise] TRY RandomForestClassifier 
# ADD YOUR CODE HERE
...
# Try prediction
sample_id = 1510
print('Prediction:',sgd_clf.predict([X_train[sample_id]]))
print('True label:',y_train[sample_id])
...
print('No. of binary classifiers:',len(ova_clf.estimators_))
...
print('\n\nNo. of binary classifiers:',len(ovo_clf.estimators_))
sample_scores = ovo_clf.decision_function([X_train[sample_id]]) 
print('\nScores:',sample_scores)

#%% 5.3. [exercise] Try RandomForestClassifier 
# ADD YOUR CODE HERE
...
if let_plot:
    ...
    plt.ylabel("Actual class")
    plt.colorbar()
    plt.savefig(r"figs\confusion_matrix_errors_plot")
    plt.show()
...
# In[9]: [exercise] ERROR ANALYSIS FOR RANDOM FORREST CLASSIFIER 
# ADD YOUR CODE HERE
...
#%% 10.4. [exercise] Try RandomForestClassifier
# ADD YOUR CODE HERE
